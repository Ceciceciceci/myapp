        ...
        return (
            <section id="about" className="about-container">
                ...
                <div className="about-desc">
                    I'm a hybrid between a <span className="ff-s">full-stack dev</span> (with a main focus in front-end) and a <span className="ff-s">ui / ux designer</span> . I graduated from San Jose State University with a Bachelor's of Science degree in Software Engineering. Check out <Link to="/resume" title="Click to see my resume"><b>my resume</b></Link> here!
                    <p>Currently located in California and a Web Developer working at Classic Vacations under Expedia. I've worked for <b>CISCO, Disney, Aerohive Networks,</b> and done several freelancing work.</p>
