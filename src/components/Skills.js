                ...
                <div className="desc">
                    <div className="lang">
                        ...
                        <svg  className="scissors" width="379" height="379" viewBox="0 0 379 379" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ellipse cx="329.247" cy="198.323" rx="30.0549" ry="34.9932" transform="rotate(-68.7952 329.247 198.323)" fill="#E8DDC7"/>
                            <ellipse cx="200.495" cy="330.677" rx="30.0549" ry="34.9932" transform="rotate(-25.1944 200.495 330.677)" fill="#E8DDC7"/>
                        </svg>
